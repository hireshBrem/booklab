...
export default function GetStarted() {
    ...
    return(
        <div className='text-white font-martian_mono'>
            <button className='bg-gradient-to-tr from-indigo-500 to-[#BA68C8] rounded-l-sm p-2 mt-5' onClick={async() => {await addReaderToWaitingList(email);setEmail("");console.log("func called")}}>Sign Up</button>           

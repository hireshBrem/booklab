...
export default function PDFViewer({book}: {book: any}) {
    ...
    return (
    <div className='mb-24 font-martian_mono'>
    ...
    <div className='flex justify-center'>
        ...
        <Document className="border-4 border-indigo-500 rounded-md" file={book.data} onLoadSuccess={onDocumentLoadSuccess}>
            <Page renderAnnotationLayer={false} renderTextLayer={false} height={794} scale={1} pageNumber={pageNumber} />
        </Document>
        <div className='flex flex-col items-center'>
        <button onClick={()=>{
        ...
        }} className='p-2 mx-2 rounded-md self-start bg-gradient-to-tr from-indigo-500 to-[#BA68C8]'>Next Page</button>
        <div className='bg-gray-700 rounded-md p-2 flex flex-col justify-center ml-2 mt-2'>
            {   
                book.comments ?
                ...
                <>
                <button onClick={()=>{
                }} className='bg-gradient-to-tr from-indigo-500 to-[#BA68C8] p-2 rounded-md font-bold w-fit content-center mt-3 ml-2'> Start comment! </button>
                </>
            }
        <form>

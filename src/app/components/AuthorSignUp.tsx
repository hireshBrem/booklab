...
export default function AuthorSignUp() {
    ...
    return(
        <div className='text-white font-martian_mono'>
            <Link href="/"><button className='bg-gradient-to-tr from-indigo-500 to-[#BA68C8] rounded-l-sm p-2 mt-5' onClick={() => {startTransition(() => addAuthorToWaitingList(email));setEmail("");console.log("func called!")}}>Sign Up</button></Link>            
